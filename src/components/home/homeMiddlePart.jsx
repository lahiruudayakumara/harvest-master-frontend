...
const HomeMiddlePart = () => {
  return (
    <div className="home-middle-upper-parent">
        ...
        <div className="home-middle-lower">
          <div className="home-middle-lower-sb">
            <div className="home-middle-lower-sb-image-left">
              <img
                src={homeMiddleLeftUpperImage}
                alt="home-middle-left-upper"
              />
            </div>
            <div className="home-middle-lower-sb-text-right">
              <div className="home-middle-lower-sb-text-right-upper">
                ...
                <p>
                  ...
                  cultivation, ensuring the land is level and hydrated matching
                  to the needs and requirements of the rice seeds planted.
              ...
              <div className="home-middle-lower-sb-text-right-lower">
                ...
                <p>
                  ...
                  chosen rice variety, which are full and identical in size,
                  free of weed seeds, and seed-borne diseases, insects and other
                  matter.
                </p>
              </div>
            </div>
            ...
            <div className="home-middle-lower-sb-text-right">
              <div className="home-middle-lower-sb-text-right-upper">
                ...
                <p>
                  ...
                  at different stages of growth. By maintaining flooded
                  conditions in a rice field, farmers can preserve soil organic
                  matter and receive natural nitrogen, enhancing crop yield
                  without the need for artificial nitrogen fertilizers
                </p>
              </div>
              <div className="home-middle-lower-sb-text-right-lower">
                <h3>CROP HEALTH MANAGEMENT</h3>
                <p>
                  Crop health management is crucial, as healthy crops can
                  attract pests and diseases. Before resorting to pesticides,
                  it&apos;s best to prevent conditions that attract harmful
                  organisms. Creating an anti-ecosystem for pests and diseases
                  can naturally reduce their impact on crops.
                </p>
              </div>
            </div>
          </div>
          <div className="home-middle-lower-sb">
            ...
            <div className="home-middle-lower-sb-image-right">
              <img
                src={homeMiddleLeftLowerImage}
                alt="home-middle-left-lower"
              />
            </div>
          </div>
        </div>
