    ...
    <div>
      ...
      <div className="mapdiv">
        ...
        >
          <a
            xlinkTitle="Kandy"
            xlinkHref="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Kandy"
            target="_blank"
          >
            <path
          ...
          <a xlinkTitle="Matale" target="_blank">
            <path
          ...
          <a xlinkTitle="Nuwara Eliya" target="_blank">
            <path
          ...
          <a xlinkTitle="Ampara" target="_blank">
            <path
          ...
          <a xlinkTitle="Batticaloa" target="_blank">
            <path
          ...
          <a xlinkTitle="Polonnaruwa" target="_blank">
            <path
          ...
          <a xlinkTitle="Trincomalee" target="_blank">
            <path
          ...
          <a xlinkTitle="Anuradhapura" target="_blank">
            <path
          ...
          <a xlinkTitle="Vavuniya" target="_blank">
            <path
          ...
          <a xlinkTitle="Mannar" target="_blank">
            <path
          ...
          <a xlinkTitle="Mullativu" target="_blank">
            <path
          ...
          <a xlinkTitle="Jaffna" target="_blank">
            <path
          ...
          <a xlinkTitle="Kilinochchi" target="_blank">
            <path
          ...
          <a xlinkTitle="Moneragala" target="_blank">
            <path
